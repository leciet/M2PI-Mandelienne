...
Détermination de l'existence d'une association entre gènes et maladies complexes
Méthode p-value empirique : n'a pas besoin que la distribution de nos maladies complexes soient normales
```{r}
