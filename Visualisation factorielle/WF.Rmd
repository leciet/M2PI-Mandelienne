...
```{r}
asso_origin_sorensen <- AssignGene(o_sorensen_mat)[[2]]
asso_origin_ochiai <- AssignGene(o_ochiai_mat)[[2]]
...
asso_acm_eucli <- association_wide_eucli
asso_acm_manh <- association_wide_manhattan

#Test poids egaux 
poids <- c(0.25, 0.25)
matrices <- list(asso_acm_eucli, asso_acm_manh, asso_origin_ochiai, asso_origin_sorensen)
