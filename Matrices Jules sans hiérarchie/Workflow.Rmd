...
Ici on cherche à caluler des distances binaires, c'est-à-dire des distances sur une matrice binaire avec **1=Présence** et **0=Absence**. <br> On note :
:::
...
Les calculs de distance étant assez longs, nous avons sauvegarder les matrices dans des objets RData. Le code suivant permet de charger les matrices dans notre environnement
:::
