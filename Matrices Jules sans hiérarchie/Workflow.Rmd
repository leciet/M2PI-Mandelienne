...
3. **Interprétation des associations gène-maladie** par le biais d'un large modèle de langage (LLM).
...
plot.MFA(res.mfa.toutes.distances,choix = 'group',palette = custom_colors)
...
Une autre méthode afin d'obtenir une matrice d'assignation est de passer par une classification. 
